...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (web-mode yaml-mode which-key use-package undo-tree tidy tide smartparens smart-mode-line realgud paredit org-bullets neotree meghanada markdown-mode magit key-chord imenu-anywhere idea-darkula-theme highlight-symbol helm-swoop helm-projectile helm-descbinds helm-ag groovy-mode expand-region elpy elixir-mode crux company-quickhelp ag adoc-mode ace-window))))
(custom-set-faces
